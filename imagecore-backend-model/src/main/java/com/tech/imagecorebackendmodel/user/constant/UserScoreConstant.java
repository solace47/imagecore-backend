...
public interface UserScoreConstant {
    ...
    String THUMBNAIL_PICTURE = "thumbPic";
    String BETHUMBNAIL_PICTURE = "beThumbPic";
    String TEXT_TO_IMAGE = "text2Image";
    String AI_SEARCH_PICTURE = "AISearch";
    String MONTH_VIP = "monthVIP";
    String PICTURE_COMMENT = "pictureComment";
